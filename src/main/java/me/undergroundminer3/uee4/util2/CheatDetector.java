...
public final class CheatDetector {
	...
	public final static void detectCheats(boolean silence) {
	...
	public final static void checkShutdown() {
		if (stop) {
	...
	private final static void detectEE3() {
		boolean ee = true;
	...
	private final static void detectCheats_do() {
		...
		if (ic2 == true) {
			LogHelper.warn("[UEE4] Future: Whats for dinner? IC2 is for dinner, and electric pipes are coming soon!");
		}
	}
}
